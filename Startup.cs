...
namespace TreasureL
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TreasureLContext>();
            ...
            services.AddScoped<TreasureL.Areas.Admin.Interfaces.IKhachHangService, TreasureL.Areas.Admin.Services.KhachHangService>();
            services.AddScoped<INhanVienService, NhanVienService>();
            services.AddScoped<TreasureL.Areas.Admin.Interfaces.IDonHangService, TreasureL.Areas.Admin.Services.DonHangService>();
